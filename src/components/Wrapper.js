  ...
  render() {
    ...
    return (
      <View>
        ...
        >
          <Image source={suhsiPic} style={{ width: 100, height: 100 }} id="" />
        </TouchableHighlight>
        <Modal
          animationType="slide"
          transparent={false}
